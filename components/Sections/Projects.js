        ...
        <Wrapper>
          ...
          <div className={style.about_center}>
            ...
            <div className={style.about_text}>
              <p>
                С 2008 года успешно работает Repino Club – премиальный
                коттеджный поселок на берегу Финского залива. Гости Репино
                могут арендовать таунхаусы на любой срок и наслаждаться отдыхом
                на закрытой территории с инфраструктурой кантри-клаба.{" "}
              </p>
            </div>
          </div>
